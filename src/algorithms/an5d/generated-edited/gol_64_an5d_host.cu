...
#define cudaCheckKernel() \
  do { \
    cudaCheckReturn(cudaGetLastError()); \
      ...
      unsigned long long *dev_grid;
      
      cudaCheckReturn(cudaMalloc((void **) &dev_grid, (size_t)(2) * (size_t)(y_size_ext) * (size_t)(x_size_ext) * sizeof(unsigned long long)));
      
{
      cudaCheckReturn(cudaMemcpy(dev_grid, grid, (size_t)(2) * (size_t)(y_size_ext) * (size_t)(x_size_ext) * sizeof(unsigned long long), cudaMemcpyHostToDevice));
#ifdef STENCILBENCH
...
#define AN5D_TYPE unsigned
      ...
      AN5D_TYPE __side0LenMax;
      {
        ...
        {
          _64_kernel0_4<<<k0_dimGrid, k0_dimBlock>>> (dev_grid, x_size_ext, y_size_ext, iters, c0);
        }
      }
        ...
        {
          {
            ...
            dim3 k0_dimBlock(__blockSize, 1, 1);
            dim3 k0_dimGrid(1 * ((__c1Len + __side1Len - 1) / __side1Len) * ((__c2Len + __side2Len - 1) / __side2Len), 1, 1);
            _64_kernel0_2<<<k0_dimGrid, k0_dimBlock>>> (dev_grid, x_size_ext, y_size_ext, iters, c0);
          }
          c0 += 1;
          {
            const AN5D_TYPE __side0Len = 2;
        ...
        {
          {
            ...
            dim3 k0_dimBlock(__blockSize, 1, 1);
            dim3 k0_dimGrid(1 * ((__c1Len + __side1Len - 1) / __side1Len) * ((__c2Len + __side2Len - 1) / __side2Len), 1, 1);
            _64_kernel0_3<<<k0_dimGrid, k0_dimBlock>>> (dev_grid, x_size_ext, y_size_ext, iters, c0);
          }
          c0 += 1;
          {
            ...
            dim3 k0_dimBlock(__blockSize, 1, 1);
            dim3 k0_dimGrid(1 * ((__c1Len + __side1Len - 1) / __side1Len) * ((__c2Len + __side2Len - 1) / __side2Len), 1, 1);
            _64_kernel0_1<<<k0_dimGrid, k0_dimBlock>>> (dev_grid, x_size_ext, y_size_ext, iters, c0);
          }
          c0 += 1;
          {
            const AN5D_TYPE __side0Len = 1;
...
SB_STOP_INSTRUMENTS;
#endif
      cudaCheckReturn(cudaMemcpy(grid, dev_grid, (size_t)(2) * (size_t)(y_size_ext) * (size_t)(x_size_ext) * sizeof(unsigned long long), cudaMemcpyDeviceToHost));
}
