...
#define __pet_none 0
#define GOL_OP(a, b, c, d, e, f, g, h, i) __32_BITS__GOL_BITWISE_COL_COMPUTE(a, b, c, d, e, f, g, h, i)
...
#define AN5D_TYPE unsigned
    ...
    unsigned int __reg_0;
    unsigned int __reg_1_0;
    unsigned int __reg_1_1;
    unsigned int __reg_1_2;
    unsigned int __reg_2_0;
    unsigned int __reg_2_1;
    unsigned int __reg_2_2;
    unsigned int __reg_3_0;
    unsigned int __reg_3_1;
    unsigned int __reg_3_2;
    unsigned int __reg_4_0;
    unsigned int __reg_4_1;
    unsigned int __reg_4_2;
    __shared__ unsigned int __a_sb_double[__blockSize * 2];
    unsigned int *__a_sb = __a_sb_double;
    ...
    #define __DB_SWITCH() do { __a_sb = &__a_sb_double[(__a_sb == __a_sb_double) ? __blockSize : 0]; } while (0)
    #define __CALCSETUP(a) do { __DB_SWITCH(); __a_sb[__tid] = a; __syncthreads(); } while (0)
    #define __CALCEXPR_1(out, a) do { unsigned int etmp; __CALCEXPR_1_wrap(etmp, a); out += etmp; } while (0);
    #define __DEST (grid[(((c0 + 1) % 2) * y_size_ext + c1) * x_size_ext + c2])
    #define __REGREF(reg, i2) reg
    #define __SBREF(sb, i2) __sbref_wrap(sb, (int)__tid + i2)
    ...
    #define __DB_SWITCH() do { __a_sb = &__a_sb_double[(__a_sb == __a_sb_double) ? __blockSize : 0]; } while (0)
    #define __CALCSETUP(a) do { __DB_SWITCH(); __a_sb[__tid] = a; __syncthreads(); } while (0)
    #define __CALCEXPR_2(out, a) do { unsigned int etmp; __CALCEXPR_2_wrap(etmp, a); out += etmp; } while (0);
